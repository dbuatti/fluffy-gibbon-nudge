...
interface CompositionMetadataSheetProps {
  imp: {
    id: string;
...
const CompositionMetadataSheet: React.FC<CompositionMetadataSheetProps> = ({
  imp,
  isPending,
  ...
  return (
    <Sheet>
      ...
      <SheetContent side="right" className="sm:max-w-md space-y-6 pt-10">
        <SheetHeader>
...
export default CompositionMetadataSheet;