...
// Artwork is no longer directly generated by AI and uploaded, so artwork_url will be null.
// This helper now just returns the artwork_url directly from the imp object, which will be null
// unless the user manually uploads it (future feature).
